...
## Files not to touch
If you follow the workflow mentionned above, 3 files will be created .
1. .gitignore
2. .terraform.lock.hcl
3. terraform.tfstate

Those files must not be touched in any way before passing the certification and even after. If you do you will be fired.
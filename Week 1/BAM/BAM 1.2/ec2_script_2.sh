...
<body>
    <h1>"I found my wife on a party yacht in Martinique! Her name is Alexia!"</h1>

    <img src="https://github.com/Melanated-Cyber-Kings/Class7-Homework/blob/Van-Ngila-Homework-Branch/African/img.JPG">

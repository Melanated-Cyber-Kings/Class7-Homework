...
![EC2 Dashboard](/Individual-Homework/01-week-01/graphics/aws-ec2-dashboard.png)
...
- Under Network & Security > Security Groups
    ...
    ![SecurityGroup](/Individual-Homework/01-week-01/graphics/aws-security-group-01.png)
  

    - Select Create Security Group 
    - Verify the newly created SG has the settings you require.

    ![Completed SG](/Individual-Homework/01-week-01/graphics/completed-security-group.png)
...
6. EC2 Deployment
    ...
    - Create a new key pair. 
        ...
        ![Create Key pair](/Individual-Homework/01-week-01/graphics/aws-ec2-create-key-pair.png)
    ...
    - Network Settings.
        ...
        ![network settings](/Individual-Homework/01-week-01/graphics/aws-ec2-network-settings.png)

    - Configure Storage: Leave this as is.

        ![configure storage default](/Individual-Homework/01-week-01/graphics/aws-ec2-configure-storage.png)
    ...
    - Advanced details.
        ...
        ![user-data-field](/Individual-Homework/01-week-01/graphics/aws-ec2-user-data-with-content.png)
    
    - Under the Summary field select Launch Instance. 

        ![EC2 summary](/Individual-Homework/01-week-01/graphics/aws-ec2-summary.png)

        If all of your settings were correct then you should see a green banner stating that the launch was successful.

        ![Launch successful](/Individual-Homework/01-week-01/graphics/aws-ec2-launch-successful.png)
    ...
    ![Webpage-example-deployment](/Individual-Homework/01-week-01/graphics/example-webpage.png)
...
![AWS Terminate EC2 Example](/Individual-Homework/01-week-01/graphics/aws-ec2-terminate-instance.png)

- Select the refresh icon to make sure all instances are terminated.

![AWS EC2 terminated](/Individual-Homework/01-week-01/graphics/aws-ec2-terminated-instances.png)
...
- Network & Security > Security Groups
 ...
 ![AWS VPC Custom SG](/Individual-Homework/01-week-01/graphics/aws-vpc-custom-security-group.png)
...
![EC2 Dashboard](/Individual-Homework/01-week-01/graphics/ec2-dashboard-instance.png)


![EC2 Terminated Instances](/Individual-Homework/01-week-01/graphics/aws-ec2-terminated-instances.png)